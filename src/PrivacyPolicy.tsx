  ...
  return (
    <Container className="emptyBackground">
      ...
      <div className="textBox">
        <h1>Privacy Policy for Onrefs</h1>
        At Onrefs, accessible from onrefs.com, one of our main priorities is the
        privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by Onrefs and how we use it.
        ...
        in Onrefs. This policy is not applicable to any information collected
        ...
        <h2>Log Files</h2>
        Onrefs follows a standard procedure of using log files. These files log
        ...
        Like any other website, Onrefs uses 'cookies'. These cookies are used to
        ...
        advertising partners of Onrefs. Third-party ad servers or ad networks
        uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on Onrefs,
        ...
        that Onrefs has no access to or control over these cookies that are used
        by third-party advertisers.
        <h2>Third Party Privacy Policies</h2>
        Onrefs's Privacy Policy does not apply to other advertisers or websites.
        ...
        participate in, and/or monitor and guide their online activity. Onrefs
